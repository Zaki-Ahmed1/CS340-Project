// ...UNCOMMENT THE DIFFERENT PORT NUMBERS FOR DEPLOYING AND RUNNING LOCALLY VS. ON OSU...
// ----------------------------------------------------START---------------------------------------------------------
...
// LOCAL INSTANCE
// app.get('/', function(request, response){
//     response.sendFile('index.html', { root: './pages-local' });
// });
// app.get('/index', function(request, response){
//     response.sendFile('index.html', { root: './pages-local' });
// });
// app.get('/products', function(request, response){
//     response.sendFile('products.html', { root: './pages-local' });
// });
// app.get('/employees', function(request, response){
//     response.sendFile('employees.html', { root: './pages-local' });
// });
// app.get('/customers', function(request, response){
//     response.sendFile('customers.html', { root: './pages-local' });
// });
// app.get('/orders', function(request, response){
//     response.sendFile('orders.html', { root: './pages-local' });
// });
// app.get('/carts', function(request, response){
//     response.sendFile('carts.html', { root: './pages-local' });
// });
